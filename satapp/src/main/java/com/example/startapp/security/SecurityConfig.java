package com.example.startapp.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .requestMatchers(HttpMethod.POST,"/nota").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST,"/personal").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST,"/ubicacion").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/incidencia/**").hasRole("USER" + "ADMIN")
                ...
                .requestMatchers(HttpMethod.PUT,"/nota/**").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.DELETE,"/nota/**").hasRole("ADMIN")
